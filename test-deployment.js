...
async function testEndpoints() {
  ...
  try {
    ...
    const healthResponse = await fetch(`${API_BASE}/python`);
    ...
    const routeResponse = await fetch(`${API_BASE}/shortest-route`, {
      method: 'POST',
      headers: {
    ...
    const analysisResponse = await fetch(`${API_BASE}/network-analysis`);
